...
console.log(lambdaStudentThree.stomach);
 ...
 function Baby(name, age, favoriteToy) {
  ...
  /* 
    ...
    1. Window Binding if no rules apply this defaults to the window unless you are in strict mode
    2. Implicit Binding Applies to objects with methods when the function is invoked look to the left of the dot that is what this referes to
    3. Explicit Binding .call or apply will immediately invoke the function bind wont
